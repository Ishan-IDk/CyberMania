...
! function (t) {
    ...
    i.resize = k(u, E), i.scroll = k(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = k(), i.location = function (t) {
       window.location = t
       ...
       t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (h = t.domready), l.each(r, v), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === _.state() && A()
    ...
    window.tram = function (t) {
       ...
       var O = e.frame = function () {
          ...
          D = f(P, function (t, e) {
             ...
             t.init = function () {
                e.init.apply(this, arguments), this.current || (this.current = {}, Z.perspective && X.perspective && (this.current.perspective = X.perspective, G(this.el, this.name, this.style(this.current)), this.redraw()))
             }, t.set = function (t) {
    ...
    i.define("brand", t.exports = function (t) {
       ...
       return n.ready = function () {
          ...
          /\.webflow\.io$/i.test(h) && u.hostname !== h && (s = !0), s && !c && (e = e || (n = t('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs"), i = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-icon.f67cd735e3.svg").attr("alt", "").css({
             marginRight: "8px",
             width: "16px"
          }), a = t().attr("src", ).attr("alt", ), n.append(i, a), n[0]), d(), setTimeout(d, 500), t(r).off(f, l).on(f, l))
       }, n
    })
 }, function (t, e, n) {
    "use strict";
       ...
       return {
          ready: function () {
             var t = e.WF_CLICK_EMPTY,
                n = e.WF_CLICK_SCROLL;
             a.on(n, d, w), a.on(t, l, function (t) {
                t.preventDefault()
    ...
    n(0).define("touch", t.exports = function (t) {
       ...
       function i(e) {
          ...
          e.addEventListener("touchstart", u, !1), e.addEventListener("touchmove", c, !1), e.addEventListener("touchend", f, !1), e.addEventListener("touchcancel", l, !1), e.addEventListener("mousedown", u, !1), e.addEventListener("mousemove", c, !1), e.addEventListener("mouseup", f, !1), e.addEventListener("mouseout", l, !1), this.destroy = function () {
             e.removeEventListener("touchstart", u, !1), e.removeEventListener("touchmove", c, !1), e.removeEventListener("touchend", f, !1), e.removeEventListener("touchcancel", l, !1), e.removeEventListener("mousedown", u, !1), e.removeEventListener("mousemove", c, !1), e.removeEventListener("mouseup", f, !1), e.removeEventListener("mouseout", l, !1), e = null
          }
       }
